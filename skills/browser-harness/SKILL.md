...
Direct browser control via CDP. For task-specific edits, use `agent-workspace/agent_helpers.py`. For setup, install, or connection problems, read [references/install.md](references/install.md), or https://github.com/browser-use/browser-harness/blob/main/install.md for the full version.
